...
// src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDE2Qy_cQs5pw6PFfQSlfXY29k37kZgLls&q=Delhi
const Contact = (props) => {
  return (
    <div>
  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      {/* <iframe width="100%" height="100%" title="map" className="absolute inset-0 grayscale contrast-50 opacity-100" frameBorder="0" marginHeight="0" marginWidth="0" scrolling="no"
      ...
      <iframe width="100%" title="map" height="600" className="absolute inset-0 grayscale contrast-50 opacity-100" frameBorder="0" marginHeight="0" marginWidth="0" scrolling="no" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Delhi+(NGO)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><Link to="https://www.gps.ie/wearable-gps/">Kids wearables</Link></iframe>
      ...
      <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <Link to='#' className="text-green-400 leading-relaxed">example@email.com</Link>
    ...
    <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <p className="text-xs text-gray-400 text-opacity-90 mt-3">Our NGO is one of the best of all times.</p>
    </div>
  </div>
</section>
    </div>
